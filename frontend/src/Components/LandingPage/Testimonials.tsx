...
type TestimonialRole = "student" | "company"

type TestimonialsProps = {
  role?: TestimonialRole
}

const Testimonials = ({ role }: TestimonialsProps) => {
  const visibleTestimonials = role
    ? testimonials.filter((testimonial) => testimonial.role === role)
    : testimonials
