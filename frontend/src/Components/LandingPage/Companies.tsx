...
const Companies = () => {
    return (
        <AnimatedSection animation="slide-up" className="py-14">
            <div className="site-container text-3xl sm:text-4xl text-center font-semibold mb-10 text-mine-shaft-100">Trusted by <span className="text-bright-sun-400">1000+</span> Companies</div>
